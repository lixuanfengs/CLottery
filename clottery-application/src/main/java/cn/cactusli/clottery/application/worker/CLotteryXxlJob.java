package cn.cactusli.clottery.application.worker;
 ...
 */
@Component
public class CLotteryXxlJob {

    private Logger logger = LoggerFactory.getLogger(CLotteryXxlJob.class);
    ...
    @XxlJob("clotteryActivityStateJobHandler")
    ...
    @XxlJob("clotteryOrderMQStateJobHandler")
    public void clotteryOrderMQStateJobHandler() {
        ...
        // 获取分库分表配置下的分表数
        int tbCount = idbRouterStrategy.tbCount();
        ...
        for (String param : params) {
            ...
            // 判断配置指定扫描库数，是否存在
            if (dbCount > idbRouterStrategy.dbCount()) {
